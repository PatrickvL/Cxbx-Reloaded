...
// D3D11 DXGI_FORMAT logging
ENUM2STR_START(DXGI_FORMAT)
	ENUM2STR_CASE(DXGI_FORMAT_UNKNOWN)
	ENUM2STR_CASE(DXGI_FORMAT_R32G32B32A32_FLOAT)
	ENUM2STR_CASE(DXGI_FORMAT_R32G32B32A32_UINT)
	ENUM2STR_CASE(DXGI_FORMAT_R32G32B32_FLOAT)
	ENUM2STR_CASE(DXGI_FORMAT_R16G16B16A16_FLOAT)
	ENUM2STR_CASE(DXGI_FORMAT_R16G16B16A16_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R16G16B16A16_SNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R32G32_FLOAT)
	ENUM2STR_CASE(DXGI_FORMAT_R10G10B10A2_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R8G8B8A8_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R8G8B8A8_SNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R16G16_FLOAT)
	ENUM2STR_CASE(DXGI_FORMAT_R16G16_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R16G16_SNORM)
	ENUM2STR_CASE(DXGI_FORMAT_D32_FLOAT)
	ENUM2STR_CASE(DXGI_FORMAT_R32_FLOAT)
	ENUM2STR_CASE(DXGI_FORMAT_R32_UINT)
	ENUM2STR_CASE(DXGI_FORMAT_D24_UNORM_S8_UINT)
	ENUM2STR_CASE(DXGI_FORMAT_R24_UNORM_X8_TYPELESS)
	ENUM2STR_CASE(DXGI_FORMAT_R8G8_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R8G8_SNORM)
	ENUM2STR_CASE(DXGI_FORMAT_D16_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R16_FLOAT)
	ENUM2STR_CASE(DXGI_FORMAT_R16_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R16_UINT)
	ENUM2STR_CASE(DXGI_FORMAT_R8_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R8_UINT)
	ENUM2STR_CASE(DXGI_FORMAT_A8_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_BC1_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_BC2_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_BC3_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_B5G6R5_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_B5G5R5A1_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_B8G8R8A8_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_B8G8R8X8_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_B4G4R4A4_UNORM)
	ENUM2STR_CASE(DXGI_FORMAT_R24G8_TYPELESS)
	ENUM2STR_CASE(DXGI_FORMAT_YUY2)
ENUM2STR_END_and_LOGRENDER(DXGI_FORMAT)
