...
#define CXBX_D3DVS_VIEWPORT_SCALEINVERSE_MIRROR_BASE      (CXBX_D3DVS_CONSTREG_VREGDEFAULTS_FLAG_BASE + CXBX_D3DVS_CONSTREG_VREGDEFAULTS_FLAG_SIZE)
#define CXBX_D3DVS_VIEWPORT_SCALE_MIRROR_SIZE      1

#define CXBX_D3DVS_VIEWPORT_OFFSET_MIRROR_BASE     (CXBX_D3DVS_VIEWPORT_SCALEINVERSE_MIRROR_BASE + CXBX_D3DVS_VIEWPORT_SCALE_MIRROR_SIZE)
