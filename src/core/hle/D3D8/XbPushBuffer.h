...
extern int XboxFVF_GetNumberOfTextureCoordinates(DWORD dwFVF, int aTextureIndex);
extern UINT XboxFVFToVertexSizeInBytes(DWORD dwFVF, BOOL bIncludeTextures);
