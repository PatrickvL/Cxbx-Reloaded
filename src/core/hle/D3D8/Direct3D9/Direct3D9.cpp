...
void UpdateFixedFunctionVertexShaderState()
{
	...
	pointSize_Min *= (float)g_RenderUpscaleFactor;
	pointSize_Max *= (float)g_RenderUpscaleFactor;
	...
	ffShaderState.PointSprite.PointScale_A = PointScaleEnable ? pointScale_A : 1.0f;
	ffShaderState.PointSprite.PointScale_B = PointScaleEnable ? pointScale_B : 0.0f;
	ffShaderState.PointSprite.PointScale_C = PointScaleEnable ? pointScale_C : 0.0f;
