...
/*typedef byte_t bytes_t[4];

bytes_t get_bytes_from_float4(uniform float4 value)
{
	bytes_t Result;
	Result[0] = get_byte_0_from_float4(value);
	Result[1] = get_byte_1_from_float4(value);
	Result[2] = get_byte_2_from_float4(value);
	Result[3] = get_byte_3_from_float4(value);
	return Result;
}*/
...
static const byte_t PS_TEXTUREMODES_NONE = 0x00L;                 // * * * *
static const byte_t PS_TEXTUREMODES_PROJECT2D = 0x01L;            // * * * *
static const byte_t PS_TEXTUREMODES_PROJECT3D = 0x02L;            // * * * *
static const byte_t PS_TEXTUREMODES_CUBEMAP = 0x03L;              // * * * *
static const byte_t PS_TEXTUREMODES_PASSTHRU = 0x04L;             // * * * *
static const byte_t PS_TEXTUREMODES_CLIPPLANE = 0x05L;            // * * * *
static const byte_t PS_TEXTUREMODES_BUMPENVMAP = 0x06L;           // - * * *
static const byte_t PS_TEXTUREMODES_BUMPENVMAP_LUM = 0x07L;       // - * * *
static const byte_t PS_TEXTUREMODES_BRDF = 0x08L;                 // - - * *
static const byte_t PS_TEXTUREMODES_DOT_ST = 0x09L;               // - - * *
static const byte_t PS_TEXTUREMODES_DOT_ZW = 0x0aL;               // - - * *
static const byte_t PS_TEXTUREMODES_DOT_RFLCT_DIFF = 0x0bL;       // - - * -
static const byte_t PS_TEXTUREMODES_DOT_RFLCT_SPEC = 0x0cL;       // - - - *
static const byte_t PS_TEXTUREMODES_DOT_STR_3D = 0x0dL;           // - - - *
static const byte_t PS_TEXTUREMODES_DOT_STR_CUBE = 0x0eL;         // - - - *
static const byte_t PS_TEXTUREMODES_DPNDNT_AR = 0x0fL;            // - * * *
static const byte_t PS_TEXTUREMODES_DPNDNT_GB = 0x10L;            // - * * *
static const byte_t PS_TEXTUREMODES_DOTPRODUCT = 0x11L;           // - * * -
static const byte_t PS_TEXTUREMODES_DOT_RFLCT_SPEC_CONST = 0x12L; // - - - *
// 0x13-0x1f reserved
...
static const byte_t PS_DOTMAPPING_ZERO_TO_ONE = 0x00L;     // - * * *
static const byte_t PS_DOTMAPPING_MINUS1_TO_1_D3D = 0x01L; // - * * *
static const byte_t PS_DOTMAPPING_MINUS1_TO_1_GL = 0x02L;  // - * * *
static const byte_t PS_DOTMAPPING_MINUS1_TO_1 = 0x03L;     // - * * *
static const byte_t PS_DOTMAPPING_HILO_1 = 0x04L;          // - * * *
// ? 0x05L ?
// ? 0x06L ?
static const byte_t PS_DOTMAPPING_HILO_HEMISPHERE = 0x07L; // - * * *
...
//enum PS_COMPAREMODE
static const byte_t PS_COMPAREMODE_S_LT = 0x00L;
static const byte_t PS_COMPAREMODE_S_GE = 0x01L;
static const byte_t PS_COMPAREMODE_T_LT = 0x00L;
static const byte_t PS_COMPAREMODE_T_GE = 0x02L;
static const byte_t PS_COMPAREMODE_R_LT = 0x00L;
static const byte_t PS_COMPAREMODE_R_GE = 0x04L;
static const byte_t PS_COMPAREMODE_Q_LT = 0x00L;
static const byte_t PS_COMPAREMODE_Q_GE = 0x08L;
...
return aInput.Diffuse; // TODO : Even this stays black; Input doesn't seem to work? FIXME!!
	...
	byte_t texture_mode_bytes[3];
	texture_mode_bytes[0] = get_byte_0_from_float4(D3DRS_PSTEXTUREMODES);
	texture_mode_bytes[1] = get_byte_1_from_float4(D3DRS_PSTEXTUREMODES);
	texture_mode_bytes[2] = get_byte_2_from_float4(D3DRS_PSTEXTUREMODES);

	byte_t texture_modes[4];
	texture_modes[0] = fmod(texture_mode_bytes[0], 32); // 5 bits, 0:[4..0]
	texture_modes[1] = (fmod(texture_mode_bytes[1],  4) * 16) + floor(texture_mode_bytes[0] / 32); // 1:[1..0],0:[7..5]
	texture_modes[2] = fmod(floor(texture_mode_bytes[1] / 4), 32); // 1:[6..2]
