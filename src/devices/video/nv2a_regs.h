...
#define NV2A_MAX_TRANSFORM_PROGRAM_LENGTH 136 // XFPR capacity: 136 instruction slots (0x88) in Kelvin XF SRAM
#define NV2A_VERTEXSHADER_CONSTANTS 192       // XFCTX capacity: 192 float4 constant registers in Kelvin XF SRAM
