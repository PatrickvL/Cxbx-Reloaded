...
class EmuShared : public Mutex
{
	public:
		...
		void GetPixelShaderMode(int* value) { Lock(); *value = m_hacks.PixelShaderMode; Unlock(); }
		void SetPixelShaderMode(const int* value) { Lock(); m_hacks.PixelShaderMode = *value; Unlock(); }
